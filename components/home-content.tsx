    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-10">
        <div className="space-y-16">
          <ContentSection title={t.home.latestEpisodes} href="/catalog">
          ...
          <ContentSection title={t.home.trendingNow} href="/catalog">
            <div className="flex gap-5 overflow-x-auto pb-6 scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
          ...
          <ContentSection title={t.home.topRated} href="/catalog">
            <div className="flex gap-5 overflow-x-auto pb-6 scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
